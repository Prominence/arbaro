...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -60970256;
    ...
    /**
     * The column <code>public.user.isActive</code>.
     */
    public final TableField<UserRecord, Boolean> ISACTIVE = createField(DSL.name("isActive"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
